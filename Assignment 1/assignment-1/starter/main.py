...
def main():
    ...
    for i in range(0, len(start_states)):    
        ...
        cost, expanded_diskstra = dijktra(start, goal, gridded_map) # Implement here the call to your Dijkstra's implementation for start, goal, and gridded_map
