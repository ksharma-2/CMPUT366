...
def main():
    ...
    for i in range(0, len(start_states)):   
        ...
        cost, expanded_astar = Astar(start, goal, gridded_map, astarpath + str(i))  # Replace None, None with a call to your implementation of A*
        ...
        cost, expanded_mm = mm(start, goal, gridded_map, mmpath + str(i)) # Replace None, None with a call to your implementation of MM
